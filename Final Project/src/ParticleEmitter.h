...
typedef enum { DirectionalEmitter, RadialEmitter, SphereEmitter , CircularDirectionalEmitter, HalfSphereEmitter} EmitterType;
...
public:
    ...
    void setAngularVelocity(const float v) { angularVelocity = v; }
